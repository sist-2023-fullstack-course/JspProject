    ...
    <h2 class="sectiontitle">상품</h2>
      <div class="row">
        <div class="text-center">
          ...
          <a href="../goods/goods_list.do?type=3" class="btn btn-sm btn-primary">신상품</a>
          <a href="../goods/goods_list.do?type=4" class="btn btn-sm btn-info">특가 상품</a>
        </div>
      </div>
