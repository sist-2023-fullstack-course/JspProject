 	      ...
 	      <table class="table">
 	        ...
 	        <tr>
 	          ...
 	          <td width=90% class="inline">
 	            ...
 	            <input type=button value="중복체크" class="btn btn-sm btn-success" id="idBtn">  
 	          </td>
 	        </tr>
 	        ...
 	        <tr>
 	          ...
 	          <td width=90% class="inline">
 	            ...
 	            <input type=button value="전화번호 중복체크" class="btn btn-sm btn-warning" id=phoneBtn>
 	          </td>
 	        </tr>
 	        ...
 	        <tr>
 	          ...
 	          <td width=90% class="inline">
 	            ...
 	            <input type=button value="이메일 중복체크" class="btn btn-sm btn-danger" id=emailBtn>
 	          </td>
 	        </tr>
 	        ...
 	        <tr>
 	          ...
 	          <td width=90% class="inline">
 	            ...
 	            <input type=button value="닉네임 중복체크" class="btn btn-sm btn-success" id="nicknameBtn">
 	          </td>
 	        </tr>
